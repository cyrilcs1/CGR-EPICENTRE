%in this prg depth /mag/ time could be read and sequence could be made
%based on condition aplied on varable magcoarse and magcoarse1


nvrtx = 4;
filename='case22v3.xlsx';
filename1='case23v3.xlsx';
